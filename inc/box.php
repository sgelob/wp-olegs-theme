...
<article class="box">
	<a class="box-inner" href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="bookmark" itemprop="relatedLink">
		...
		<img src="<?php echo str_replace(".jpg", "-320x320.jpg", $thumb_url); ?>"
			data-srcset="<?php echo str_replace(".jpg", "-320x320.jpg", $thumb_url); ?> 320w,
			<?php echo str_replace(".jpg", "-480x480.jpg", $thumb_url); ?> 480w,
			<?php echo str_replace(".jpg", "-768x768.jpg", $thumb_url); ?> 768w"
			data-sizes="auto"
			data-optimumx="1.5"
			class="lazyload"
